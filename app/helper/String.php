...
class String
{
     ...
     * @return string
     */
    static function fliterScript($value)
    {
     ...
     * @return string
     */
    static function fliterHtml($value)
    {
     ...
     * @return string
     */
    static function fliterSql($value)
    {
     ...
     * @return string|array
     */
    static function fliterEscape($value)
    {
        if (is_array($value)) {
     ...
     * @return string
     */
    static function fliterStr($value)
    {
     ...
     * @return string
     */
    static function  filterDir($fileName)
    {
